				...
				<MenuList boxShadow={shadow} p="0px" mt="10px" borderRadius="20px" bg={menuBg} border="none">
					...
					<Flex flexDirection="column" p="10px">
						<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius="8px" px="14px">
							<Text fontSize="sm" onClick={() => navigate(`/admin/`)} >Home</Text>
						</MenuItem>
						<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius="8px" px="14px">
							<Text fontSize="sm" onClick={() => navigate(JSON.parse(localStorage.getItem('user'))?.role === 'admin' ? `/admin/userView/${JSON.parse(localStorage.getItem('user'))?._id}` : `/userView/${JSON.parse(localStorage.getItem('user'))?._id}`)} >Profile Settings</Text>
						</MenuItem>
						{/*<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius="8px" px="14px">
