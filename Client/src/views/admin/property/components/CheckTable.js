    ...
    <>
      ...
      <Modal onClose={() => { setAdvaceSearch(false); resetForm() }} isOpen={advaceSearch} isCentered>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button size="sm" colorScheme='brand' mr={2} onClick={handleSubmit} disabled={isLoding || !dirty ? true : false} >{isLoding ? <Spinner /> : 'Search'}</Button>
      ...
      <Modal onClose={() => { setManageColumns(false); resetForm() }} isOpen={manageColumns} isCentered>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button size="sm" colorScheme='brand' mr={2} onClick={() => {
