                            ...
                            <Text fontSize="md" fontWeight="900" textAlign={"center"} >
                              <Menu isLazy  >
                                ...
                                <MenuList minW={'fit-content'} transform={"translate(1520px, 173px);"}>
                                  ...
                                  {access?.view && <MenuItem py={2.5} color={'green'} onClick={() => navigate(user?.role !== 'admin' ? `/propertyView/${cell?.row?.values._id}` : `/admin/propertyView/${cell?.row?.values._id}`)} icon={<ViewIcon fontSize={15} />}>View</MenuItem>}
